...
#define cpu_map_h
  ...
  */
  ...
  #define LIMIT_PORT_0 J
  #define LIMIT_PORT_1 J
  #define LIMIT_PORT_2 D
  #define LIMIT_BIT_0 0 // X Limit Max - Pin D2
  #define LIMIT_BIT_1 1 // Y Limit Max - Pin D15
  #define LIMIT_BIT_2 2 // Z Limit Max - Pin D19
  #define _LIMIT_BIT(i) LIMIT_BIT_##i
  #define LIMIT_BIT(i) _LIMIT_BIT(i)
  #define LIMIT_DDR(i) _DDR(LIMIT_PORT_##i)
  #define LIMIT_PORT(i) _PORT(LIMIT_PORT_##i)
  #define LIMIT_PIN(i) _PIN(LIMIT_PORT_##i)
  
  #define HLIMIT_DDR       DDRJ
  #define HLIMIT_PORT      PORTJ
  #define HLIMIT_PIN       PINJ
  #define HX_LIMIT_BIT     1 // MEGA2560 Digital Pin 10
  #define HY_LIMIT_BIT     2 // MEGA2560 Digital Pin 11

  #define HLIMIT_INT       PCIE1  // Pin change interrupt enable pin
  #define HLIMIT_INT_vect  PCINT1_vect 
  #define HLIMIT_PCMSK     PCMSK1 // Pin change interrupt register
  #define HLIMIT_MASK ((1<<HX_LIMIT_BIT)|(1<<HY_LIMIT_BIT)) // All limit bits
