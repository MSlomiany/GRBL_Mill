...
static void report_util_setting_string(uint8_t n) {
  ...
  serial_write('(');
  switch(n) {
    case 0: printPgmString(PSTR("długość impulsu")); break;
    case 1: printPgmString(PSTR("opóźnienie wyłączenia silników")); break; 
    case 2: printPgmString(PSTR("odwrócenie sygnału kroku")); break;
    case 3: 
      printPgmString(PSTR("odwrócenie kierunku osi; 0, 1=X, 2=Y, 3=XY, 4=Z, 5=XZ, 6=YZ, 7=XYZ"));
      break;
    case 4: printPgmString(PSTR("Sygnał enable [0 lub 1]")); break;
    case 5: printPgmString(PSTR("Rezystory pull-up dla krańcówek")); break;
    case 6: printPgmString(PSTR("Probe invert")); break;
    case 10: printPgmString(PSTR("Status urządzenia")); break;
    case 11: printPgmString(PSTR("Junction deviation")); break;
    case 12: printPgmString(PSTR("Arc tolerance")); break;
    case 13: printPgmString(PSTR("milimetry/cale")); break;
    case 20: printPgmString(PSTR("Limity sotware'owe")); break;
    case 21: printPgmString(PSTR("Hard limity")); break;
    case 22: printPgmString(PSTR("Homing przy uruchomieniu")); break;
    case 23: printPgmString(PSTR("Odwrócenie kierunku homingu")); break;
    case 24: printPgmString(PSTR("Homing feed")); break;
    case 25: printPgmString(PSTR("Homing seek")); break;
    case 26: printPgmString(PSTR("Czas drgania krańcówek")); break;
    case 27: printPgmString(PSTR("Homing pulloff")); break;
...
{
  printPgmString(PSTR("\r\nGrbl " GRBL_VERSION " PILC Premium Edition ['$' for help]\r\n"));
}
