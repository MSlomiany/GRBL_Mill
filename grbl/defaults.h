...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_BACKLASH_MM 0.5
  #define DEFAULT_Y_BACKLASH_MM 0.5
  #define DEFAULT_Z_BACKLASH_MM 0.5
  ...
  #define DEFAULT_X_STEPS_PER_MM 2460.0
  #define DEFAULT_Y_STEPS_PER_MM 2460.0
  #define DEFAULT_Z_STEPS_PER_MM 2460.0
  #define DEFAULT_X_BACKLASH_MM 0.275
  #define DEFAULT_Y_BACKLASH_MM 0.3
  #define DEFAULT_Z_BACKLASH_MM 0.5
  #define DEFAULT_X_MAX_RATE 100.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 100.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 100.0 // mm/min
  #define DEFAULT_X_ACCELERATION (1.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (1.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (1.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
